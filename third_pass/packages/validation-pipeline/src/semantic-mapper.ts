...
/**
 * Helper function to map a component to a ShadCN schema
 */
export function mapComponentToSchema(figmaNode: FigmaNode, componentType: ComponentType): SemanticMappingResult {
  return SemanticMapper.mapComponent(figmaNode, componentType);
}
